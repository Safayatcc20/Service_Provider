    ...
    public electrisian() {
        ...
        public void connect() {
            try {
                ...
                con = java.sql.DriverManager.getConnection("jdbc:mysql://localhost/utility service provider", "username", "password");
                
            } 
            catch (ClassNotFoundException | SQLException ex) {
                Logger.getLogger(electrisian.class.getName()).log(Level.SEVERE, null, ex);
            }
        } 
...
//        this.dispose();
    ...
    private void jButton85ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton85ActionPerformed
        // TODO add your handling code here:
        int workerid = 1; // WorkerID value
        try {
            PreparedStatement pst = con.prepareStatement("SELECT WorkerName, `Contact No.` FROM worker WHERE WorkerID = ?");
            pst.setInt(1, workerid); // Set the WorkerID for which you want to retrieve details

            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                String workerName = rs.getString("WorkerName");
                String workerContactNo = rs.getString("Contact No.");

                Hire hirePage = new Hire();
                hirePage.setWorkerDetails(workerName, workerContactNo); // Pass the worker details to the HirePage
                hirePage.setVisible(true);
                this.dispose();
            } else {
                // Handle the case when no worker details are found for the provided WorkerID
                JOptionPane.showMessageDialog(this, "Worker details not found.");
            }
