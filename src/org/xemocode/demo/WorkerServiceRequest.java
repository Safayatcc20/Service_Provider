 ...
 * @author Saif
 */
public class WorkerServiceRequest extends javax.swing.JFrame {

    /**
     * Creates new form WorkerServiceRequest
     */
    public WorkerServiceRequest() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Service Name", "Schedule", "Price", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WorkerServiceRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WorkerServiceRequest().setVisible(true);
            }
        });
    }
